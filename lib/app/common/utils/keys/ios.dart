class KeysIosApp {
  ...
  static const storageIOS = String.fromEnvironment('IOS_STORAGE_KEY');
  static const clientIdIOS = String.fromEnvironment('IOS_CLIENT_KEY');
  static const bundleIdIOS = String.fromEnvironment('IOS_BUNDLEID_KEY');
}
